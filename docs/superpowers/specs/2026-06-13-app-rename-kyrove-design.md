...
- ✅ Consistent: name, tagline, domain strategy all reinforce the same concept
- ✅ Scoped: focused on the naming decision, not implementation details
- ✅ Unambiguous: clear what changes and what doesn't
